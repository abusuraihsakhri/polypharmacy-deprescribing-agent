"""
Automated Pytest for polypharmacy-deprescribing-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    CognitiveEngine,
    MedicationEngine,
    PolypharmacydeprescribingagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = PolypharmacydeprescribingagentEnrichmentSuite()
