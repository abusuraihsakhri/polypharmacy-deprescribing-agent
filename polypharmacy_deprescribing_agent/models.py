"""
Clinical Data Models & Enums for DeprescribeMind: Beers 2023 Criteria & STOPP/START Geriatric Medication Agent.
...
class AgentAlert:
    ...
    guideline_citation: str = "AGS Beers Criteria 2023 & STOPP/START"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
